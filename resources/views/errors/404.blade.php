...
@keyframes hover {
  ...
  <h1>404</h1>
  <h3>Halo <span>Traveller</span><br> Coba Cek Lagi Dehh Url-nya, Jangan Sering Tersesat Ya #ikon_senyum </h3>
  ...
  <a href="#"><button class="denied__link">Balik Ke Rumah Ya</button></a>
</div>
 </body>
 <script>
 	 var particles = {
